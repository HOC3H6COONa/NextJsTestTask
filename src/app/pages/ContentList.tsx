            ...
            <div className="bg-[#ffffff] w-full overflow-y-auto max-h-[100vh]">
                <ul className="divide-y divide-gray-200 pl-[16px]">
                    {itemsList.map((item, idx) => (
                        <li
                            key={idx}
                            className={`py-[16px] pr-[16px] text-[17px] leading-[23px] font-[400] font-[Raleway] text-[#1B1822] flex flex-row items-center justify-between`}
                        ...
                        >
                            ...
                            {activeItem === item &&
                                ...
                                >
                                    <path d="M1.19922 5.23844L4.55922 8.59844L11.7592 1.39844" stroke="#FC3F1D"
